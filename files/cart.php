        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 mt-2">			
				<?php $ca = $order->GetCartData(); ?>
              <div class="cartListInner text-wrap">
                <form action="#">
					<div class="d-flex border bg-light border-light">
					  <div class="justify-content-start p-1">
						<div class="cartImage"><img src="<?php echo $ca["cover_dir"];?>" alt="image" class="img-thumbnail" width="150"></div>
					  </div>
					  <div class="p-1">
						<h4><?php echo $ca["name"];?></h4>
						<p><?php echo $ca["description"];?></p>
					  </div>
					</div>				
                  <div class="updateArea">
					<div class="col-12">
						<h4><i class="fa-solid fa-calendar-days gold"></i> Rendi aeg</h4>
						<div>
							<ul class="mt-1">
								<li>Algus: <strong><?php echo $ca["start"];?></strong></li>
								<li>Lõpp: <strong><?php echo $ca["end"];?></strong></li>
							</ul>
						</div>

						<h4><i class="fa-solid fa-truck-fast gold"></i> Kauba saatmine/kättesaamine</h4>
						<div>
							* Toote saab kätte hetkel ainult käest-kätte Saaremaa piires!
						</div>
					</div>
                  </div>
                  ...
                  <div class="row totalAmountArea">
                    <div class="col-sm-5 ms-sm-auto">
                      <ul class="list-unstyled">
                        <li>Kokku maksta: <span><?php echo $ca["price"];?> €</span></li>
                      </ul>
                    </div>
                  </div>

                  <div class="checkBtnArea">
                    <button onClick="OrderPay(<?php echo $ca["id"];?>);" class="btn btn-primary btn-default">Maksma<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                  </div>
                </form>
              </div>
            </div>
